...
!function (a) {
            ...
            if (b.radiusInput && b.radiusInput.on("change", function (b) {
                ...
                c.autocomplete = new google.maps.places.Autocomplete(b.locationNameInput.get(0), c.settings.autocompleteOptions), google.maps.event.addListener(c.autocomplete, "place_changed", function () {
                    ...
                    f.originalEvent && setTimeout(function () {
                        ...
                        f.length > 5 && d && (d = !1, c.geodecoder.geocode({address: f}, function (a, d) {
    ...
    function h(b, c, d) {
        var e = a.extend({}, a.fn.locationpicker.defaults, d), g = e.location.latitude, h = e.location.longitude, j = e.radius, k = b.settings.location.latitude, l = b.settings.location.longitude, m = b.settings.radius;
    ...
    var i = {
        drawCircle: function (b, c, d, e) {
            ...
            for (var c = null, d = a.length - 1; d >= 0; d--)a[d].types.indexOf(b) >= 0 && (c = a[d]);
            return c || a[0]
        }, updateLocationName: function (a, b) {
            a.geodecoder.geocode({latLng: a.marker.position}, function (c, d) {
    ...
    a.fn.locationpicker = function (j, k) {
        ...
        return this.each(function () {
            ...
            var l = a.extend({}, a.fn.locationpicker.defaults, j), m = new b(this, a.extend({}, l.mapOptions, {
                zoom: l.zoom,
        ...
        mapOptions: {},
        scrollwheel: !0,
        inputBinding: {latitudeInput: null, longitudeInput: null, radiusInput: null, locationNameInput: null},
